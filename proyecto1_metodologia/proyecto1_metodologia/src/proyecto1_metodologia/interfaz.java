...
/**
 * Esta es la interfaz que hemos creado para preguntar que metodo quiere usar para hayar los primeros numeros tetraedricos de n.
 * Te preguntara un numero y con el numero que metas usara un metodo o otro para resolver
 * 
 *	 @author Alejandro de la Rosa Sanchez
 * 	 @author Cristina Ortiz Martin
 *   @author Alejandro Pimentel Mozos
 *   @author Cristopher azariel santaiti
 *   @author Marcos Blanco Diaz
 *   @version 1.0
 *   
 */
